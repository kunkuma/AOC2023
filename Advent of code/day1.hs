...
repl str = case str of
    _ | "one" `isPrefixOf` str -> '1' : repl (drop 2 str)
    _ | "two" `isPrefixOf` str -> '2' : repl (drop 2 str)
    _ | "three" `isPrefixOf` str -> '3' : repl (drop 4 str)
    _ | "four" `isPrefixOf` str -> '4' : repl (drop 3 str)
    _ | "five" `isPrefixOf` str -> '5' : repl (drop 3 str)
    _ | "six" `isPrefixOf` str -> '6' : repl (drop 2 str)
    _ | "seven" `isPrefixOf` str -> '7' : repl (drop 4 str)
    _ | "eight" `isPrefixOf` str -> '8' : repl (drop 4 str)
    _ | "nine" `isPrefixOf` str -> '9' : repl (drop 3 str)
...
main = do
    ...
    print $ repl "iowu27dgdisi3eighthree"
